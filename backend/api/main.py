...
from backend.api.routers import (
    ...
    # ai_chat,  # Temporarily disabled to avoid sentence-transformers dependency
)
...
# app.include_router(ai_chat.router, prefix=settings.API_V1_STR, tags=["ai-chat"])  # Temporarily disabled
