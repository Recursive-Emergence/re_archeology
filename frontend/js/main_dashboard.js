/**
 * Main Dashboard Application for RE-Archaeology Framework
 * Handles authentication, thread management, AI chat, and background tasks
 * Optimized for performance with lazy loading and proper error handling
 */
...
class MainDashboardApp {
    constructor() {
        ...
        this._threadService = null;
        this._aiChatService = null;
        this._backgroundTasksService = null;
        this._earthEngineService = null;
    ...
    get aiChatService() {
        if (!this._aiChatService) {
            this._aiChatService = new AIChatService();
        }
        return this._aiChatService;
    }

    get backgroundTasksService() {
        if (!this._backgroundTasksService) {
            this._backgroundTasksService = new BackgroundTasksService();
        }
        return this._backgroundTasksService;
    }

    get earthEngineService() {
        if (!this._earthEngineService) {
            this._earthEngineService = new EarthEngineService();
        }
        return this._earthEngineService;
    }
    ...
    async init() {
        try {
            ...
            console.log('Main Dashboard App initialized successfully');
        } catch (error) {
            console.error('Failed to initialize Main Dashboard App:', error);
    ...
    async handleInitializationError(error) {
        this.hideLoading();
        this.showError('Initialization failed. Please try reloading the page.');
...
document.addEventListener('DOMContentLoaded', () => {
    window.app = new MainDashboardApp();
});
